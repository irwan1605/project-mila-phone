// src/pages/stock/StockAccessoriesPusat.jsx
...
// accessories juga boleh punya IMEI/Serial → kunci utama imei, fallback nama
const makeKey = (row) => {
...
export default function StockAccessoriesPusat({ user }) {
  ...
  function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "ACC_PUSAT");
    const ymd = today().replace(/-/g, "");
    XLSX.writeFile(wb, `STOCK_ACC_PUSAT_${ymd}.xlsx`);
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold">Stok Accessories — PUSAT</h1>
      ...
      {open && targetRow && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-4 w-full max-w-lg">
            <h3 className="text-lg font-semibold mb-3">Transfer Accessories dari PUSAT ke Toko</h3>
