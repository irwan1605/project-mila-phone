...
const SalesReportAccessories = () => {
  const navigate = useNavigate();
  const asscessoriesSales = [
    {
      id: 1,
      tanggal: "02/01/2024",
  ...
  return (
    ...
    <button
      ...
      <h1 className="text-3xl font-bold mb-6">
        Laporan Penjualan Accessories - Toko 1
      </h1>
      <table className="table-auto w-full mb-8 bg-white shadow-md rounded-lg">
        ...
        <tbody>
          {asscessoriesSales.map((sale, index) => (
...
export default SalesReportAccessories;
